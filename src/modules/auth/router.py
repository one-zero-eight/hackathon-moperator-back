...
async def by_credentials(
    credentials: EmailAuthCredentials, auth_repository: Annotated[AuthRepository, DEPENDS_AUTH_REPOSITORY]
):
...
async def by_tag(credentials: TagAuthCredentials, auth_repository: Annotated[AuthRepository, DEPENDS_AUTH_REPOSITORY]):
